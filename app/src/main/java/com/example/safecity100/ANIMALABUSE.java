...
public class ANIMALABUSE extends AppCompatActivity {
        ...
        if (name.isEmpty()){
            ...
            StringRequest request = new StringRequest(Request.Method.POST, "https://safecity724.000webhostapp.com/insert.php",
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            if(response.equalsIgnoreCase("Data Stored")){
                                Toast.makeText(ANIMALABUSE.this, "Data Stored", Toast.LENGTH_SHORT).show();
                                progressDialog.dismiss();
                            }
                            else {
                                Toast.makeText(ANIMALABUSE.this, response, Toast.LENGTH_SHORT).show();
                                progressDialog.dismiss();
                            }
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(ANIMALABUSE.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(ANIMALABUSE.this);
