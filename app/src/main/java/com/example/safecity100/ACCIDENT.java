        ...
        if (name.isEmpty()){
            ...
            StringRequest request = new StringRequest(Request.Method.POST, "https://safecity724.000webhostapp.com/insert.php",
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            if(response.equalsIgnoreCase("Data Stored")){
                                Toast.makeText(ACCIDENT.this, "Data Stored", Toast.LENGTH_SHORT).show();
                                progressDialog.dismiss();
                            }
                            else {
                                Toast.makeText(ACCIDENT.this, response, Toast.LENGTH_SHORT).show();
                                progressDialog.dismiss();
                            }
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(ACCIDENT.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(ACCIDENT.this);
