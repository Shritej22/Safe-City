        ...
        if (name.isEmpty()){
            ...
            StringRequest request = new StringRequest(Request.Method.POST, "https://safecity724.000webhostapp.com/insert.php",
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            if(response.equalsIgnoreCase("Data Stored")){
                                Toast.makeText(CRIME.this, "Data Stored", Toast.LENGTH_SHORT).show();
                                progressDialog.dismiss();
                            }
                            else {
                                Toast.makeText(CRIME.this, response, Toast.LENGTH_SHORT).show();
                                progressDialog.dismiss();
                            }
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(CRIME.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(CRIME.this);
